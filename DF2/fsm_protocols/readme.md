...
- `spi_slave.vhd`
  ...
  - в мастрі tx_shift_reg передає дату для slave, яку задає тб, одночасно буде приймати бітову послідовність в rx_shift_reg. 
  - в слейві в регістрі rx_shift_reg буде прийматись значення, яке надсилає мастер, сам слейв з tx_shift_reg буде передавати якусь свою константу
  - це має бути full-duplex передача
